...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_fbd5541cf357b195e8593b4ca0b1c94e');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_fbd5541cf357b195e8593b4ca0b1c94e');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_fbd5541cf357b195e8593b4ca0b1c94e');
        ...
        $d->setProxyDir('C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/AsignacionesUsuarios/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/AsignacionesUsuarios/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod',
            ...
            'session.save_path' => 'C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/xampp/htdocs/AsignacionesUsuarios/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/AsignacionesUsuarios/app/cache/prod/doctrine/orm/Proxies',
